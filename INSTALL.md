...
### Source code
- Download [Version 3.7](https://github.com/sepandhaghighi/art/archive/v3.7.zip) or [Latest Source ](https://github.com/sepandhaghighi/art/archive/dev.zip)
...
- `pip install art==3.7` or `pip3 install art==3.7` (Need root access)
...
- Run `easy_install "art==3.7"` (Need root access)
