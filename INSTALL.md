...
### Source code
- Download [Version 3.2](https://github.com/sepandhaghighi/art/archive/v3.2.zip) or [Latest Source ](https://github.com/sepandhaghighi/art/archive/dev.zip)
...
- `pip install art==3.2` or `pip3 install art==3.2` (Need root access)
...
- Run `easy_install "art==3.2"` (Need root access)
