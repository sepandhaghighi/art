...
### Source code
- Download [Version 3.8](https://github.com/sepandhaghighi/art/archive/v3.8.zip) or [Latest Source ](https://github.com/sepandhaghighi/art/archive/dev.zip)
...
- `pip install art==3.8` or `pip3 install art==3.8` (Need root access)
...
- Run `easy_install "art==3.8"` (Need root access)
