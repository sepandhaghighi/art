...
### Source code
- Download [Version 4.8](https://github.com/sepandhaghighi/art/archive/v4.8.zip) or [Latest Source ](https://github.com/sepandhaghighi/art/archive/dev.zip)
...
- `pip install art==4.8` or `pip3 install art==4.8` (Need root access)
...
- Run `easy_install "art==4.8"` (Need root access)
